    ...
    return (
      <main className="flex flex-col min-h-screen w-screen">
        ...
        <section className='flex flex-col   text-6xl  gap-6 items-center text-customblue pt-8'>
            ...
            <h4 className='text-4xl '>Your #1 for birthday reminders and planning</h4>
            <button className='bg-customblue w-[400px] h-[50px] mt-[30px] self-auto text-3xl text-white rounded-3xl'>Log in</button>
        </section>
