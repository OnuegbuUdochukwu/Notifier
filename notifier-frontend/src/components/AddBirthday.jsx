...
const AddBirthday = ({ open, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-30 flex justify-center items-center px-2  ">
      <div className="relative w-full  bg-white rounded-xl p-4 max-h-[60vh] overflow-y-auto max-w-[500px] shadow-lg">
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col items-center gap-6 mt-6">
          ...
          <div className="w-full">
            <p className="text-sm font-medium mb-1 text-[#09455D]">Birthday</p>
            <div className="flex gap-2">
              <div className="w-1/2">
                <label className="block text-sm mb-1 text-gray-500">Day</label>
                <select
                  name="birthdayDay"
              ...
              <div className="w-1/2">
                <label className="block text-sm mb-1 text-gray-500">Month</label>
                <select
                  name="birthdayMonth"
          ...
          <div className="w-full">
            <p className="text-sm font-medium mb-1 text-[#09455D]">Reminder</p>
