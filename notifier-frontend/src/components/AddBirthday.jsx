...
const AddBirthday = ({ isopen, onClose }) => {
    ...
    <>
      {isopen && (
        <div          onClick={onClose}
          ...
          className={
            "fixed inset-0 z-50 bg-black bg-opacity-40 flex justify-center items-center px-2"
          }
        >
          <div
          ...
          className="relative  bg-white rounded-xl p-4 max-h-[60vh] w-auto overflow-y-auto max-w-[600px] shadow-lg">
            ...
            <div className="flex flex-col items-center gap-6 mt-6">
              ...
              <p className="text-base text-[#09455D] mt-[-20px]">
                Fill in the details and we’d be sure to do the rest!
              </p>
              ...
              <p className=" text-[#09455D] text-lg mt-[-20px]">
                Upload Picture
              </p>
              ...
              <div className="w-full">
                <div className="flex flex-row ">
                  ...
                  <p className="text-sm font-medium mb-5 ml-2 text-[#09455D]">
                    Birthday
                  </p>
                </div>
              ...
              <div className="w-full">
                <p className="text-sm font-medium mb-1 ml-2 text-[#09455D]">
                  Remainder
                </p>
